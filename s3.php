<?php
	...
	// AWS Info: AKIAJXI3VVSE2L4ZG7WA
	// Secret access key: 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
	$bucketName = 'requestbuckettest';
	// Access key ID
	$IAM_KEY = 'AKIAJXI3VVSE2L4ZG7WA';
	$IAM_SECRET = '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';
	// Connect to AWS
	try {
	...
	$keyName = "";
	$keyName = 'images/' . basename($_FILES["fileToUpload"]['tmp_name']);
