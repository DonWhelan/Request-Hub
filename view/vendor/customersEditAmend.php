<?php 
    ...
    include("../../model/selectModel_customersEdit.php"); 
            ...
            <div class="col-md-12">
                <div class="card p-30">
                    ...
                    <?php
                        ...
                        $uid = getUID($_GET['uid']);
                        $array = select_prepared_customersEditAmend("../../",$uid,$company);
                    ?>
                    <br><br>
                    <form action="../../controler/customerAmendUser.php?uid=<?php echo $uid; ?>" method="post" name="Login_Form" class="form-signin">
                        ...
                        <div class="form-group col-md-6 float-right">
                            <!-- Role -->
                            <label for="dis" class="control-label"><b>Password</b></label>
                            <input type="password" class="form-control" id="pwMatch" name="pwMatch" placeholder="" >
                        </div>
